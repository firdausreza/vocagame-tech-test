...
export default function ProfilePage() {
	...
	const onSubmit = (e: any) => {
		...
		if (JSON.stringify(editedUser) === JSON.stringify(currentUser)) {
			toast.error("No change on user data");
			return;
		}
	...
	return (
		<section className="dark:bg-gray-800 min-h-[100vh]">
			<section className="max-w-5xl lg:max-w-6xl mx-auto px-4 lg:px-0 py-8">
				<article id="profile-header" className="w-full flex flex-col">
					...
					>
						...
						<div
							id="profile-header__data"
							className="ms-4 dark:text-white"
						>
				...
				<article id="profile-dashboard" className="w-full flex mt-8">
					<aside
						...
						className="hidden lg:flex flex-col w-[20%] px-4 dark:text-white"
					>
					...
					>
						<div className="w-full flex flex-col border border-gray-200 rounded-md shadow-md p-4">
							<h5 className="text-xl pb-2 border-b border-gray-400 dark:text-white">
								Edit Profile
							</h5>
						...
						<Button
							type="button"
							text="Sign Out"
							customClass="lg:hidden px-4 py-2 rounded-md bg-red-500 hover:bg-green-700 transition-colors text-white text-sm mt-4"
